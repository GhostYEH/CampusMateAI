...
const filters = computed(() => [
  ...
  { id: "个人待办", label: "个人待办", count: store.tasks.filter((task) => task.course === "个人待办").length },
]);
const filteredTasks = computed(() => store.tasks.filter((task) => {
  ...
  if (["课程作业", "个人待办"].includes(activeFilter.value)) return task.course === activeFilter.value;
  return true;
}));
...
const listTitle = computed(() => activeFilter.value === "done" ? "已完成" : activeFilter.value === "all" ? "全部任务" : activeFilter.value === "课程作业" ? "课程作业" : activeFilter.value === "个人待办" ? "个人待办" : "待完成");
const planCards = computed(() => [
  ...
  { label: "个人待办", count: store.tasks.filter((task) => task.course === "个人待办").length, note: "本周安排", icon: "PhClipboardText", tone: "mint" },
