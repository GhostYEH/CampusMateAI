...
class MockTaskBreakdownService implements TaskBreakdownService {
  ...
  static const List<String> policyKeywords = [
    '申请', '截止', '截止时间', '办理', '材料', '证明', '学时',
    '奖学金', '助学金', '贷款', '补办', '注册', '报到', '选课',
    '退课', '请假', '休学', '复学', '转专业', '保研', '考研',
    '推免', '实习', '实践', '社会实践', '综合测评', '综测',
    '学分', '补考', '重修', '毕业', '学位', '论文', '答辩',
    '校园卡', '宿舍', '住宿', '学籍', '档案', '户口', '体检', '保险',
  ];

  /// 学习类关键词(用于规则化拆解判断)。
  static const List<String> studyKeywords = [
    '复习', '预习', '学习', '做作业', '完成作业', '刷题', '练习',
    '阅读', '看', '整理', '背诵', '记忆', '理解', '掌握', '总结',
    '写', '编程', '编码', '实现', '调试', '测试', '报告', '实验',
    '项目', '课程',
  ];
  ...
  List<TaskBreakdownStep> _buildRuleSteps(
    ...
    steps.add(
      TaskBreakdownStep(
        stepNumber: 1,
        title: '明确目标与范围',
        description: '用一句话写下本次目标: ${goal.length > 80 ? goal.substring(0, 80) : goal}。'
