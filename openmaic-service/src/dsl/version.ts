/**
 * DSL version + migration registry — ported from `@openmaic/dsl` v1.0.3
 * (`packages/@openmaic/dsl/src/version.ts`), MIT.
 *
 ...
 *
 * Ported subset (documented as such in `docs/openmaic-capability-matrix.md`):
