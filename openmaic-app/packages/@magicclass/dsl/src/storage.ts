 ...
 * document to another runtime. `@magicclass/renderer` already consumes resolved
 ...
 * future `@magicclass/exporter` package can build on the same contract.
 *
 ...
 * CDN on a server — live in `@magicclass/storage`, keeping this package
 ...
 * pure package to the DOM lib. Backends in `@magicclass/storage` accept a real
