...
import type { PPTTableElement, TableCell, TableCellBorder } from '@magicclass/dsl';
import { getTableSubThemeColor } from '@magicclass/renderer';
import { getTextStyle } from '@magicclass/renderer/elements';
