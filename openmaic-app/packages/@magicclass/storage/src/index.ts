/**
 * @magicclass/storage — the MAIC pluggable persistence layer.
 *
 * Dependency arrow (kept acyclic): `@magicclass/storage -> @magicclass/dsl` only.
...
export type { AssetRef, AssetMeta, BinaryBlob, StorageProvider } from '@magicclass/dsl';
