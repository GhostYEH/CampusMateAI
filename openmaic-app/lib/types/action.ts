...
// presentation — now lives in `@magicclass/dsl` and is re-exported below, so the
...
import type { SpeechAction as DslSpeechAction } from '@magicclass/dsl';
...
export { FIRE_AND_FORGET_ACTIONS, SLIDE_ONLY_ACTIONS, SYNC_ACTIONS } from '@magicclass/dsl';
