...
export function quizQuestionListCss(width: number): string {
  ...
  return [
    `.quiz-question-list { padding:5.2%;background:linear-gradient(145deg,#071426 0%,#102a43 56%,#133f4b 100%);font-family:"magic class Noto Sans Cyrillic","magic class Noto Sans Arabic",Inter,"magic class Noto Sans SC","magic class Noto Sans KR",sans-serif; }`,
