...
export const AGENT_EVENT_NOTIFY_CHANNEL = 'magicclass_agent_event_wakeup';
/**
 ...
 */
export const AGENT_EVENT_PROBE_CHANNEL = 'magicclass_agent_event_selfcheck';
export const AGENT_EVENT_NOTIFY_APPLICATION_NAME = 'magicclass-agent-notify-bus';
...
const GLOBAL_KEY = '__magicclassAgentEventNotifyBus';
...
const AGENT_EVENT_PROBE_PAYLOAD = 'magicclass-agent-notify-selfcheck';
