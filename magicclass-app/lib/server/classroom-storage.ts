 ...
 * `<cwd>/data/classrooms`; `MAGICCLASS_CLASSROOMS_DIR` overrides it so tests can
 * point the store at a throwaway directory instead of the repository tree.
 */
export const CLASSROOMS_DIR = process.env.MAGICCLASS_CLASSROOMS_DIR
  ? path.resolve(process.env.MAGICCLASS_CLASSROOMS_DIR)
