...
export const NAV_COLLAPSED_STORAGE_KEY = 'magicclass:workspace:nav-collapsed';
export const CHAT_COLLAPSED_STORAGE_KEY = 'magicclass:workspace:chat-collapsed';
export const CLASSROOM_COLLAPSED_STORAGE_KEY = 'magicclass:workspace:classroom-collapsed';
export const CHAT_WIDTH_STORAGE_KEY = 'magicclass:workspace:chat-width';
