...
/** localStorage keys. Same `magicclass:workspace:` namespace as the rail width. */
export const COURSE_ORDER_STORAGE_KEY = 'magicclass:workspace:course-order';
export const SESSION_ORDER_STORAGE_KEY = 'magicclass:workspace:session-order';
