...
export function isAgentRuntimeEnabled(): boolean {
  return readBoolean(process.env.MAGICCLASS_AGENT_RUNTIME_ENABLED);
}
...
export function isPiNativeChildRuntimeEnabled(): boolean {
  return readBoolean(process.env.MAGICCLASS_ENABLE_PI_NATIVE_CHILD_RUNTIME);
}
...
export function isPiNativeChildSpotlightEnabled(): boolean {
  return readBoolean(process.env.MAGICCLASS_ENABLE_PI_NATIVE_CHILD_SPOTLIGHT);
}
...
export function isVocationalTaskEngineEnabled(): boolean {
  return readBoolean(process.env.MAGICCLASS_ENABLE_VOCATIONAL);
}
