 ...
 */
import { PgAssetByteStore } from '@magicclass/storage/asset/pg-bytes';
import type { AssetByteStore, Queryable } from '@magicclass/storage/asset/pg';
...
export async function createAssetByteStore(
  ...
  const storage = await import('@magicclass/storage/asset/s3-bytes');
