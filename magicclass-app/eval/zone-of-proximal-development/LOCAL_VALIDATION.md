...
- Classroom checks used an existing local magic class runtime at `89268e5`, which includes the thinking-context fix `d5fca17` and an unrelated Feynman documentation commit. Neither change is included in this skill PR.
