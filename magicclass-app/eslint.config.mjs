  ...
  // with package.json.
  {
    ...
    rules: {
      'no-restricted-syntax': [
        ...
        {
          selector:
            'ImportDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|(jsonrepair|katex|nanoid|partial-json)(\\/|$)|node:|\\.\\.?\\/).+/]',
          message:
        ...
        {
          selector:
            'ExportNamedDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|(jsonrepair|katex|nanoid|partial-json)(\\/|$)|node:|\\.\\.?\\/).+/]',
          message:
        ...
        {
          selector:
            'ExportAllDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|(jsonrepair|katex|nanoid|partial-json)(\\/|$)|node:|\\.\\.?\\/).+/]',
          message:
            '@magicclass/generation may re-export only from @magicclass/dsl, approved leaf runtime dependencies, Node built-ins, or relative modules (./… or ../…).',
        },
        {
  ...
  // the static import allowlist to add the package public entry and Vitest.
  {
    ...
    rules: {
      'no-restricted-syntax': [
        ...
        {
          selector:
            'ImportDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|@magicclass\\/generation(\\/|$)|node:|vitest(\\/|$)|\\.\\.?\\/).+/]',
          message:
        ...
        {
          selector:
            'ExportNamedDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|@magicclass\\/generation(\\/|$)|node:|vitest(\\/|$)|\\.\\.?\\/).+/]',
          message:
        ...
        {
          selector:
            'ExportAllDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|@magicclass\\/generation(\\/|$)|node:|vitest(\\/|$)|\\.\\.?\\/).+/]',
          message:
            '@magicclass/generation tests and test config may re-export only @magicclass/dsl, the package public entry, Node built-ins, Vitest, or relative modules (./… or ../…).',
        },
        {
  ...
  //      see. A descriptor describes animation; it never renders it.
  {
    ...
    rules: {
      'no-restricted-syntax': [
        ...
        {
          selector:
            'ImportDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|zod(\\/|$)|\\.\\/).+/]',
          message:
        ...
        {
          selector:
            'ExportNamedDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|zod(\\/|$)|\\.\\/).+/]',
          message:
            'lib/choreography may re-export only from @magicclass/dsl, zod, or in-folder relatives (./…).',
        },
        {
          selector:
            'ExportAllDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|zod(\\/|$)|\\.\\/).+/]',
          message:
            'lib/choreography may re-export only from @magicclass/dsl, zod, or in-folder relatives (./…).',
        },
  ...
  // `../…` (e.g. `../action/engine`) escapes the module and is rejected.
  {
    ...
    rules: {
      'no-restricted-syntax': [
        ...
        {
          selector:
            'ImportDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|zod(\\/|$)|\\.\\/|\\.\\.\\/choreography(\\/|$)).+/]',
          message:
        ...
        {
          selector:
            'ExportNamedDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|zod(\\/|$)|\\.\\/|\\.\\.\\/choreography(\\/|$)).+/]',
          message:
            'lib/video-export root files may re-export only from @magicclass/dsl, zod, ../choreography, or in-module children (./…).',
        },
        {
          selector:
            'ExportAllDeclaration > Literal.source[value=/^(?!@magicclass\\/dsl(\\/|$)|zod(\\/|$)|\\.\\/|\\.\\.\\/choreography(\\/|$)).+/]',
          message:
            'lib/video-export root files may re-export only from @magicclass/dsl, zod, ../choreography, or in-module children (./…).',
        },
        {
