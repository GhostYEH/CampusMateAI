...
export async function register(): Promise<void> {
  ...
  // `instrumentation` is also bundled for Edge. Accessing the Node process via
  // `globalThis` keeps the Edge bundle free of a static `process.once` call;
  // the early runtime guard above makes this undefined there, while Node still
  // registers the orderly shutdown handlers below.
