 ...
 * had drifted apart before @magicclass/dsl existed:
 *   - app:      lib/types/slides.ts
 *   - renderer: packages/@magicclass/renderer/src/types/slides.ts
 *   - importer: packages/@magicclass/importer/src/magicclass/types/slides.ts
 *
