...
import { generateSceneContent, generateWidgetContent } from '@magicclass/generation';
import type { AICallFn } from '@magicclass/generation';
import type { GeneratedInteractiveContent, SceneOutline } from '@magicclass/generation';
