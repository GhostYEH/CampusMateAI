...
// Resolve `@magicclass/storage` self-imports and the `@magicclass/dsl` dependency to
...
export default defineConfig({
  resolve: {
    alias: {
      '@magicclass/storage': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
      '@magicclass/dsl': fileURLToPath(new URL('../dsl/src/index.ts', import.meta.url)),
    },
  },
  test: {
