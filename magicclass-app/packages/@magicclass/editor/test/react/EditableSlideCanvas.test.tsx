...
import { useViewportSize } from '@magicclass/renderer';
import { getLineElementPath } from '@magicclass/renderer';
...
vi.mock('@magicclass/renderer', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@magicclass/renderer')>()),
