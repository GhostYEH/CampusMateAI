...
import { SHAPE_PATH_FORMULAS } from '../magicclass/configs/shapes';
import { getSvgPathRange } from '../magicclass/utils/svgPathParser';
import { parseVideoCodec, isVideoCodecSupported } from '../magicclass/utils/videoCodec';
...
function emitWarning(
  ...
  try {
    ...
    console.error('[@magicclass/importer] onWarning sink threw (ignored):', err);
  }
}
