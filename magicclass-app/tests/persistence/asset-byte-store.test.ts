...
import { PgAssetStore, ensureAssetSchema, type Queryable } from '@magicclass/storage/asset/pg';
 ...
 * (packages/@magicclass/storage/src/asset/pg.ts `hasTransactionalWriter`), kept
