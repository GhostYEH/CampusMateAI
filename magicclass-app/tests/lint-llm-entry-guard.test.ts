 ...
 * `@magicclass` package directories excluded from the dynamic-import ban, and both
...
const GUARDED_PATHS = [
  ...
  'app/api/probe/route',
  'components/probe',
  'packages/@magicclass/renderer/src/probe',
  'packages/@magicclass/storage/src/probe',
  'packages/@magicclass/generation/src/probe',
...
describe('LLM entry-point lint guard — coverage matrix', () => {
  ...
  it('still enforces the pre-existing module boundaries it shares a rule key with', async () => {
    ...
    for (const filePath of [
      'packages/@magicclass/renderer/src/probe.ts',
      'packages/@magicclass/storage/src/probe.ts',
      'packages/@magicclass/generation/src/probe.ts',
