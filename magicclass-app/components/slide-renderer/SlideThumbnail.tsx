...
import type { Slide, PPTImageElement, PPTVideoElement } from '@magicclass/dsl';
...
/**
 * Read-only thumbnail rendering for a video element. Replaces `@magicclass/renderer`'s
...
/**
 * Read-only slide thumbnail rendered via the extracted `@magicclass/renderer`
 ...
 * is intentionally untouched (`@magicclass/renderer` v1 is read-only; editing is v2).
 */
