 ...
 *   persisted to IndexedDB by the magic class stage layer. The Modal's
...
function SubmissionModal({
  ...
  const handleFile = async (file: File) => {
    ...
    abortRef.current = ac;
    // Image / screenshot: store via magic class's existing object storage
    ...
    // PDF: parse to text via magic class's existing /api/parse-pdf (reused, not
