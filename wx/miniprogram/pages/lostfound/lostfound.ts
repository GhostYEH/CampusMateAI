...
Page({
  ...
  imageFor(item: LostFoundItem, index: number): string {
    ...
    if (category === '电子产品') return '/assets/secondary/lost-power-bank.jpg'
    if (category === '书籍资料') return '/assets/secondary/lost-book.jpg'
    return index % 2 === 0 ? '/assets/secondary/lost-power-bank.jpg' : '/assets/secondary/lost-book.jpg'
  },
