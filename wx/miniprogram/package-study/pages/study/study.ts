...
Page({
  data: {
    modes: [
      { minutes: 25, label: '专注 25 分钟', icon: '/package-study/assets/icons/focus-timer.svg' },
      { minutes: 5, label: '短休息 5 分钟', icon: '/package-study/assets/icons/focus-moon.svg' },
      { minutes: 15, label: '长休息 15 分钟', icon: '/package-study/assets/icons/focus-moon.svg' },
    ],
    targetMinutes: 25,
    secondsLeft: 25 * 60,
    status: 'idle',
