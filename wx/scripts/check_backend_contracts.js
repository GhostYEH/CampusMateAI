...
const noticesPage = read('miniprogram/package-campus/pages/notices/notices.ts')
...
const studyPage = read('miniprogram/package-study/pages/study/study.ts')
const tasksPage = read('miniprogram/pages/tasks/tasks.ts')
const noticesMarkup = read('miniprogram/package-campus/pages/notices/notices.wxml')
