...
const contracts = [
  ...
  ['custom-tab-bar/index.wxss', 'backdrop-filter: blur(24px) saturate(140%)', '底栏必须采样并柔化页面背景'],
  ['custom-tab-bar/index.wxss', 'inset 0 1px 0 rgba(255, 255, 255, 0.78)', '底栏必须包含液态玻璃内高光'],
  ['custom-tab-bar/index.wxss', 'background: linear-gradient(145deg, rgba(255, 255, 255, 0.72)', '选中项必须使用半透明玻璃胶囊'],
