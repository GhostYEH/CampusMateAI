...
from ..magicclass.fusion_errors import FusionDocumentRejected, FusionInvalidRequest

#: Mirrors ``magicclass-service/src/material/repository.ts``. The two must agree:
