...
class FusionUnavailable(AppException):
    ...
    http_status = 503
    message = "受管 magic class 服务当前不可用，请稍后重试"


class FusionInvalidRequest(AppException):
    code = "MAGICCLASS_INVALID_REQUEST"
    http_status = 400
    message = "请求参数不合法"
