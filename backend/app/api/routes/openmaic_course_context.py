...
- **只读本地库。** 知识点与资料来自 CampusMate 自己的同步结果，不经过受管
  OpenMAIC 服务。服务关掉时这里依然可用——恰恰因为如此，它才能在服务不可用
...
from ...schemas.openmaic_fusion import CourseContextOut, CourseKnowledgePointOut
from ...services.container import ServiceContainer, get_container
from ...services.openmaic.course_context import assert_course_access, build_course_facts
from ..deps import current_user

router = APIRouter(prefix="/courses", tags=["openmaic-course-context"])
...
@router.get("/{course_id}/openmaic-context", response_model=CourseContextOut)
