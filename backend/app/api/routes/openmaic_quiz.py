...
from ...schemas.openmaic_quiz import QuizAttemptIn, QuizAttemptStateOut
from ...services.container import ServiceContainer, get_container
from ...services.openmaic.course_context import assert_course_access
from ...services.openmaic.quiz_attempt_store import PHASE_ORDER, QuizAttempt, root_attempt_id
from ..deps import current_user

router = APIRouter(prefix="/courses", tags=["openmaic-quiz"])
