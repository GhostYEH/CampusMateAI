...
受管服务本身的权限与分页由 ``magicclass-service/tests/discovery.test.mjs`` 覆盖。
"""
from __future__ import annotations

from fastapi.testclient import TestClient

from app.api.routes import magicclass_discovery, magicclass_workspaces
...
def _setup(script=None, **settings_overrides):
    ...
    app.dependency_overrides[magicclass_discovery._client] = lambda: client
