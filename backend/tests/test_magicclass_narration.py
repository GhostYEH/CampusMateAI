...
from app.api.routes import magicclass_narration
...
def test_narration_posts_only_identifiers_and_answers_202():
    ...
    http.app.dependency_overrides[magicclass_narration._client] = lambda: _client(container, transport)
...
def test_narration_requires_idempotency_before_contacting_the_service():
    ...
    http.app.dependency_overrides[magicclass_narration._client] = lambda: MagicClassFusionClient(
