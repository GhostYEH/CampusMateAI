...
语义由 `magicclass-service/tests/editor.test.mjs` 覆盖。
"""
from __future__ import annotations

from fastapi.testclient import TestClient

from app.api.routes import magicclass_editor, magicclass_workspaces
...
def _setup(script=None, **settings_overrides):
    ...
    app = create_app()
    app.dependency_overrides[magicclass_editor._client] = lambda: client
