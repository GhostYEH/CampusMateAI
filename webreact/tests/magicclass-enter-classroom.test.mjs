...
} from "../src/features/magicclass/enterClassroomModel.js";

const read = (rel) => readFileSync(new URL(`../${rel}`, import.meta.url), "utf8");
const appSource = read("src/App.jsx");
const paritySource = read("src/pages/ParityPages.jsx");
const entryPageSource = read("src/pages/magicclassClassroomEntryPage.jsx");
...
test("a disabled or unreachable service is never rendered as completed", () => {
  for (const error of [
    { response: { status: 503, data: { code: "MAGICCLASS_FUSION_UNAVAILABLE", details: { reason: "fusion_disabled" } } } },
