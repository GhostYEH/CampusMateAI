...
const IslandPage = lazy(() => import("./pages/IslandPage.jsx"));
const StudySubpages = lazy(() => import("./pages/StudySubpages.jsx"));
...
const LearningStatePage = lazy(() => import("./pages/LearningStatePage.jsx"));
...
const pages = {
  ...
  FinalReviewPage, CourseResearchPage, NoticeWorkflowPage, AgentRuntimeOpsPage,
...
export default function App() {
  ...
  return <GlassSystemProvider renderer="auto" theme={{ appearance: "light", theme: { preset: "cobalt", contrast: "high" } }}><AppProvider><TypingPlaceholderLayer /><Routes><Route path="/login" element={<LoginPage />} /><Route element={<GuardedLayout />}><Route path="/" element={<Navigate to="/home" replace />} /><Route path="/home" element={<Page name="HomePage" />} /><Route path="/courses" element={<Page name="CoursesPage" />} /><Route path="/courses/:courseId" element={<Page name="CourseDetailPage" />} /><Route path="/tasks" element={<Page name="TasksPage" />} /><Route path="/tasks/:kind/:id" element={<Page name="TaskDetailPage" />} /><Route path="/community" element={<Page name="CommunityPage" />} /><Route path="/community/create" element={<Page name="CommunityCreatePage" />} /><Route path="/community/:postId" element={<Page name="CommunityDetailPage" />} /><Route path="/university" element={<Page name="UniversityPage" />} /><Route path="/counselor" element={<Page name="CounselorPage" />} /><Route path="/notifications" element={<Page name="NotificationsPage" />} /><Route path="/announcements/:announcementId" element={<Page name="AnnouncementDetailPage" />} /><Route path="/study" element={<Page name="StudyPage" />} /><Route path="/learning-state" element={<Page name="LearningStatePage" />} /><Route path="/prediction" element={<Page name="PredictionPage" />} /><Route path="/agent/final-review" element={<Page name="FinalReviewPage" />} /><Route path="/agent/course-research" element={<Page name="CourseResearchPage" />} /><Route path="/agent/notice-workflow" element={<Page name="NoticeWorkflowPage" />} /><Route path="/admin/agent-runtime" element={<Page name="AgentRuntimeOpsPage" />} /><Route path="/final-review" element={<Page name="FinalReviewPage" />} /><Route path="/course-research" element={<Page name="CourseResearchPage" />} /><Route path="/island" element={<Page name="IslandPage" />} /><Route path="/plans" element={<Page name="PlansPage" />} /><Route path="/docs" element={<Page name="DocsPage" />} /><Route path="/statistics" element={<Page name="StatisticsPage" />} /><Route path="/exams" element={<Page name="ExamsPage" />} /><Route path="/exams/:examId" element={<Page name="ExamDetailPage" />} /><Route path="/exams/:examId/edit" element={<Page name="ExamEditPage" />} /><Route path="/profile" element={<Page name="ProfilePage" />} /><Route path="/profile/chaoxing" element={<Page name="ChaoxingPage" />} /><Route path="/profile/academic" element={<Page name="AcademicPage" />} /><Route path="/profile/settings" element={<Page name="SettingsPage" />} /><Route path="/profile/:section" element={<Page name="ProfileSectionPage" />} /></Route><Route path="*" element={<Navigate to="/" replace />} /></Routes></AppProvider></GlassSystemProvider>;
}
