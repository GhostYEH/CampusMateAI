 ...
 * 只去掉 TypeScript 类型；`@/configs/image-clip` → `_compat/image-clip.js`。
 */
import { useMemo } from 'react';
import { CLIPPATHS, ClipPathTypes } from '../../../_compat/image-clip.js';

/**
 * Calculate image clip shape and position
 * @param element Image element
 */
export function useClipImage(element) {
