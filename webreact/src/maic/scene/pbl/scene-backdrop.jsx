...
/**
 * 移植自参考项目
 * `components/scene-renderers/pbl/v2/scene-stage/scene-backdrop.tsx`。
 * 仅擦除 TypeScript interface / 类型标注，去掉 `'use client'`。
 * 类名、内联 style、motion 参数、motif 槽位表逐字保留。
 *
...
export function SceneBackdrop({ visual }) {
