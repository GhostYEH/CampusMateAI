...
/**
 * 移植自参考项目
 * `components/scene-renderers/pbl/v2/eval-cards/star-rating.tsx`。
 * 仅擦除 TypeScript interface / 类型标注；类名与内联 style 逐字保留。
 *
 ...
 */
export function StarRating({ value, showDenominator, size = 16, className }) {
