/**
 * 移植自参考项目 `lib/quiz/grading.ts`。
 * 仅擦除 TypeScript 类型标注（interface / 泛型 / `as const`）。
 */
 ...
 */
export function isShortAnswer(q) {
 ...
 */
export function resolveAnswerKeyToValue(q, answer) {
 ...
 */
export function answerIncludesOption(q, optionValue) {
...
export function gradeChoiceQuestions(questions, answers) {
  return questions
