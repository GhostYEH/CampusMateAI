...
const waitForFonts = async (font) => {
  ...
  try {
    ...
    // Font loading is best effort; the browser fallback is still measurable.
  }
...
export default function ParticleText({
  ...
  useEffect(() => {
    ...
    const sampleText = async () => {
      ...
      if (reducedMotion || !animateOnMount) {
        particles.forEach((particle) => {
  ...
  }, [text, particleSize, density, color, highlightColor, scatter, gatherDuration, stagger, pointerRepel, repelRadius, idleDrift, animateOnMount, trigger, fontSize, fontWeight, fontFamily, glow]);

  return <div ref={containerRef} className={`particle-text ${className}`.trim()} style={style} aria-label={text}>
