import {
  ...
  Calendar, CalendarBlank, CaretDown, CaretRight, Check, CheckCircle, CheckSquare,
  ChatCircle, ChatsCircle, Circle, ClipboardText, Clock, Envelope, EnvelopeOpen,
  Exam, Eye, EyeSlash, File, Files, FileText, Flag, FolderOpen, FolderSimple,
  FolderSimplePlus, Gear, GraduationCap, Heart,
  ...
  ArrowCounterClockwise, SkipForward, ArrowsOut, Tree,
  SpeakerSimpleLow, SpeakerSimpleHigh, SpeakerSimpleX, Waveform,
} from "@phosphor-icons/react";

const icons = { ArrowClockwise, ArrowCounterClockwise, ArrowsOut, ArrowLeft, ArrowRight, ArrowUpRight, ArrowsClockwise, Bell, BookOpen, BookOpenText, Bookmark, BookmarkSimple, Buildings, Copy, Calendar, CalendarBlank, CaretDown, CaretRight, Check, CheckCircle, CheckSquare, ChatCircle, ChatsCircle, Circle, ClipboardText, Clock, Envelope, EnvelopeOpen, Exam, Eye, EyeSlash, File, Files, FileText, Flag, FolderOpen, FolderSimple, FolderSimplePlus, Gear, GraduationCap, Heart, HeartStraight, House, IdentificationCard, Info, Link: LinkIcon, List, ListChecks, Lock, MagnifyingGlass, MapPin, Megaphone, PaperPlaneRight, Pause, Pencil, Play, Plus, PlusCircle, QrCode, Robot, ShieldCheck, SignOut, SkipForward, Sparkle, SquaresFour, Stack, Target, Timer, Trash, Tree, User, UserCircle, WarningCircle, X, Notebook, EnvelopeSimple, ChartLineUp, SealCheck, ClockCounterClockwise, Student, PaintBrush, Layout, Planet, Question, Users, HandCoins, Coffee, Storefront, CalendarHeart, Lightbulb, DotsThree, NotePencil, ChatCircleText, UsersThree, Fire, FlagCheckered, MapTrifold, ChalkboardTeacher, TreasureChest, Star, SpeakerSimpleLow, SpeakerSimpleHigh, SpeakerSimpleX, Waveform };
