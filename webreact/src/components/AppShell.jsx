...
export default function AppShell() {
  ...
  const isMagicClass = location.pathname === "/courses" || location.pathname.includes("/magicclass-preview") || location.pathname.includes("/workspaces/");
