...
export class LoginScreen extends ViewPU {
    ...
    LoginBrand(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(28:5)", "entry");
            Row.alignItems(VerticalAlign.Center);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.Center });
            Stack.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(29:7)", "entry");
            Stack.width(40);
            Stack.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(30:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(39:7)", "entry");
            Column.alignItems(HorizontalAlign.Start);
            Column.margin({ left: 10 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('CampusMate AI');
            Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(40:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(44:9)", "entry");
    ...
    LoginField(label: string, placeholder: string, symbol: Resource, isPassword: boolean, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(56:5)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(label);
            Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(57:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 11 });
            Row.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(63:7)", "entry");
            Row.width('100%');
            Row.height(45);
            Row.alignItems(VerticalAlign.Center);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(64:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(68:9)", "entry");
            ...
            if (isPassword) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(114:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(128:7)", "entry");
    ...
    LoginContent(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(137:5)", "entry");
            Scroll.width('100%');
            Scroll.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(138:7)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(139:9)", "entry");
            Column.width('100%');
            Column.alignItems(HorizontalAlign.Start);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(142:11)", "entry");
            Blank.height(66);
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('欢迎回到校园');
            Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(144:11)", "entry");
            Text.fontColor('#FFFFFFFF');
            Text.fontSize(32);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(152:11)", "entry");
            Blank.height(8);
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('课程、通知与每一个重要截止，\n都替你稳稳记着。');
            Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(154:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(164:9)", "entry");
            Blank.height(42);
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 16 });
            Column.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(166:9)", "entry");
            Column.width('100%');
            Column.alignItems(HorizontalAlign.Start);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(167:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(173:11)", "entry");
            Text.fontColor(FORM_MUTED);
            Text.fontSize(11.5);
            Text.width('100%');
        }, Text);
            ...
            if (this.error.length > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(182:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(191:11)", "entry");
            Row.width('100%');
            Row.height(51);
            ...
            if (this.loading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(193:15)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('进入校园空间');
                        Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(198:15)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(202:15)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(220:11)", "entry");
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(238:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(239:7)", "entry");
            Image.width('100%');
            Image.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (!this.reduceMotion) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Video.create({
                            src: { "id": 16777219, "type": 20000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" },
                            previewUri: { "id": 16777217, "type": 20000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" },
                            controller: this.videoController
                        });
                        Video.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(246:9)", "entry");
                        Video.width('100%');
                        Video.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/login/LoginScreen.ets(261:7)", "entry");
            Column.width('100%');
            Column.height('100%');
