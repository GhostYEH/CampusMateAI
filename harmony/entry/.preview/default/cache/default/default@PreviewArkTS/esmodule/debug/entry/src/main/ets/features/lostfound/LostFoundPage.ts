...
export class LostFoundPage extends ViewPU {
    ...
    imageFor(index: number): Resource {
        if (index % 4 === 0)
            return $r('app.media.lost_book');
        if (index % 4 === 1)
            return $r('app.media.lost_card');
        if (index % 4 === 2)
            return $r('app.media.lost_earbuds');
    ...
    Tabs(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(36:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(38:9)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(entry[1]);
                    Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(39:11)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Rect.create();
                    Rect.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(40:11)", "entry");
                    Rect.width(32);
                    Rect.height(3);
    ...
    ItemCard(item: LostFoundItem, index: number, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(47:5)", "entry");
            Row.width('100%');
            Row.padding(11);
            Row.backgroundColor(this.palette().surface);
            Row.borderRadius(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(48:7)", "entry");
            Image.width(104);
            Image.height(92);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(49:7)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(50:9)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(item.kind === 'lost' ? '失物' : '招领');
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(51:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(53:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(item.status === 'closed' ? '已解决' : '寻找中');
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(54:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(56:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 4 });
            Row.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(57:9)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125832174, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            SymbolGlyph.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(58:11)", "entry");
            SymbolGlyph.fontSize(12);
            SymbolGlyph.fontColor([this.palette().muted]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(item.location ?? '地点未填写');
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(59:11)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
            Text.maxLines(1);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(61:9)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(9);
        }, Text);
        Text.pop();
    ...
    BrowsePage(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(68:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(69:7)", "entry");
            Column.width('100%');
            Column.padding({ left: 14, right: 14, bottom: 24 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.BottomStart });
            Stack.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(70:9)", "entry");
            Stack.width('100%');
            Stack.height(176);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create($r('app.media.hero_lost_found'));
            Image.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(71:11)", "entry");
            Image.width('100%');
            Image.height(176);
            Image.objectFit(ImageFit.Cover);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(72:11)", "entry");
            Column.padding({ left: 16, bottom: 14 });
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('失物招领');
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(73:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(74:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 9 });
            Row.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(78:9)", "entry");
            Row.width('100%');
            Row.height(52);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(79:11)", "entry");
            SymbolGlyph.fontSize(18);
            SymbolGlyph.fontColor([this.palette().muted]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create({ placeholder: '搜索物品、地点', text: this.query });
            TextInput.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(80:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(83:11)", "entry");
            Stack.width(38);
            Stack.height(38);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(84:13)", "entry");
            SymbolGlyph.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(88:9)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.kind === 'lost' ? '正在寻找' : '最新招领');
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(89:11)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(17);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(90:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`${this.filteredItems().length} 条`);
            Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(90:20)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
        }, Text);
        Text.pop();
            ...
            if (this.loading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(93:11)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(95:11)", "entry");
                        Column.width('100%');
                        Column.padding({ top: 30, bottom: 30 });
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        SymbolGlyph.create({ "id": 125831500, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
                        SymbolGlyph.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(96:13)", "entry");
                        SymbolGlyph.fontSize(32);
                        SymbolGlyph.fontColor([this.palette().muted]);
                    }, SymbolGlyph);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('没有找到匹配的失物信息');
                        Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(97:13)", "entry");
                        Text.fontColor(this.palette().text);
                        Text.fontSize(14);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(98:13)", "entry");
                        Text.fontColor(this.palette().muted);
                        Text.fontSize(11);
                    }, Text);
                    Text.pop();
    ...
    PublishPage(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(108:5)", "entry");
            Scroll.layoutWeight(1);
            Scroll.width('100%');
            Scroll.scrollBar(BarState.Off);
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(109:7)", "entry");
            Column.width('100%');
            Column.padding({ left: 17, right: 17, top: 6, bottom: 24 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 7 });
            Row.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(110:9)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(entry[1]);
                    Text.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(112:13)", "entry");
                    Text.layoutWeight(1);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(119:9)", "entry");
            TextInput.height(50);
            TextInput.fontColor(this.palette().text);
            TextInput.placeholderColor(this.palette().muted);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextArea.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(122:9)", "entry");
            TextArea.height(132);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(125:9)", "entry");
            TextInput.height(50);
            TextInput.fontColor(this.palette().text);
            TextInput.placeholderColor(this.palette().muted);
            TextInput.backgroundColor(this.palette().surface);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(127:9)", "entry");
            TextInput.height(50);
            TextInput.fontColor(this.palette().text);
            TextInput.placeholderColor(this.palette().muted);
            TextInput.backgroundColor(this.palette().surface);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(129:9)", "entry");
            Button.width('100%');
            Button.height(52);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(132:9)", "entry");
            Button.width('100%');
            Button.height(46);
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/lostfound/LostFoundPage.ets(138:5)", "entry");
            Column.width('100%');
            Column.height('100%');
