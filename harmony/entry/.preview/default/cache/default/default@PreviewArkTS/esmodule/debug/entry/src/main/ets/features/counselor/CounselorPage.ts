...
export class CounselorPage extends ViewPU {
    ...
    MessageBubble(message: ChatMessage, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(14:5)", "entry");
            Row.width('100%');
            ...
            if (message.role === 'assistant') {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Stack.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(16:9)", "entry");
                        Stack.width(30);
                        Stack.height(30);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(17:11)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Blank.create();
                        Blank.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(19:16)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(20:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (message.role === 'assistant') {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Blank.create();
                        Blank.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(26:43)", "entry");
                        Blank.layoutWeight(1);
                    }, Blank);
                    Blank.pop();
                });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(31:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(32:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 16, right: 16, top: 12, bottom: 12 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 2 });
            Column.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(33:9)", "entry");
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('AI 校园助手');
            Text.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(34:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(35:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(37:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('REAL');
            Text.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(37:18)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(39:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(40:9)", "entry");
            Column.width('100%');
            ...
            if (this.sending) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(46:31)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(47:11)", "entry");
            Blank.height(12);
        }, Blank);
        Blank.pop();
        Column.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(50:7)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(51:9)", "entry");
            Row.width('100%');
            Row.alignItems(VerticalAlign.Center);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create({ placeholder: '输入你的校园事务问题…', text: this.input });
            TextInput.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(52:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.Center });
            Stack.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(57:11)", "entry");
            Stack.width(48);
            Stack.height(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.sending) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        LoadingProgress.create();
                        LoadingProgress.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(58:33)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(59:20)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 4 });
            Row.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(62:9)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125832274, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            SymbolGlyph.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(63:11)", "entry");
            SymbolGlyph.fontSize(11);
            SymbolGlyph.fontColor([this.palette().muted]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('仅提供校园事务辅助，不替代学校正式通知或专业咨询');
            Text.debugLine("entry/src/main/ets/features/counselor/CounselorPage.ets(64:11)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
        }, Text);
        Text.pop();
