...
export class FocusPage extends ViewPU {
    ...
    ModeTabs(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 7 });
            Row.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(42:5)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(item);
                    Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(44:9)", "entry");
                    Text.layoutWeight(1);
    ...
    TimerCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(54:5)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(55:7)", "entry");
            Stack.width(230);
            Stack.height(230);
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Progress.create({ value: this.totalSeconds() - this.secondsLeft, total: this.totalSeconds(), type: ProgressType.Ring });
            Progress.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(56:9)", "entry");
            Progress.width(220);
            Progress.height(220);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(58:9)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125832304, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            SymbolGlyph.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(59:11)", "entry");
            SymbolGlyph.fontSize(24);
            SymbolGlyph.fontColor([this.palette().primary]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.timeText());
            Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(60:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(61:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(64:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild({ type: ButtonType.Capsule });
            Button.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(65:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 7 });
            Row.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(66:11)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            if (this.running) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(68:15)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(70:15)", "entry");
                        SymbolGlyph.fontSize(17);
                        SymbolGlyph.fontColor(['#FFFFFFFF']);
                    }, SymbolGlyph);
                });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(72:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(75:9)", "entry");
            Button.width(92);
            Button.height(48);
    ...
    Record(item: StudySession, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 11 });
            Row.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(82:5)", "entry");
            Row.width('100%');
            Row.padding({ top: 10, bottom: 10 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.Center });
            Stack.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(83:7)", "entry");
            Stack.width(42);
            Stack.height(42);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(84:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(86:7)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`${item.goal ?? '专注学习'} · ${item.started_at.substring(0, Math.min(10, item.started_at.length))}`);
            Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(87:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(88:9)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
        }, Text);
        Text.pop();
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(94:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(96:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(97:9)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(100:11)", "entry");
            Row.width('100%');
            Row.padding(13);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(101:13)", "entry");
            SymbolGlyph.fontSize(17);
            SymbolGlyph.fontColor([this.palette().success]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 2 });
            Column.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(102:13)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('学习状态辅助');
            Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(103:15)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(13);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(104:15)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('专注记录');
            Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(107:11)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(108:11)", "entry");
            Column.width('100%');
            ...
            if (this.loading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(109:33)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('还没有专注记录');
                        Text.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(110:52)", "entry");
                        Text.fontColor(this.palette().muted);
                        Text.fontSize(12);
                        Text.padding(28);
                    }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                if (index < this.sessions.length - 1) {
                                    this.ifElseBranchUpdateFunction(0, () => {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Divider.create();
                                            Divider.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(112:138)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/focus/FocusPage.ets(115:11)", "entry");
            Blank.height(18);
        }, Blank);
        Blank.pop();
        Column.pop();
