...
export class SecondaryHeader extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/ui/SecondaryHeader.ets(13:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/ui/SecondaryHeader.ets(14:7)", "entry");
            Stack.width(40);
            Stack.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/ui/SecondaryHeader.ets(15:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/ui/SecondaryHeader.ets(19:7)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.title);
            Text.debugLine("entry/src/main/ets/ui/SecondaryHeader.ets(20:9)", "entry");
            ...
            if (this.subtitle.length > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/ui/SecondaryHeader.ets(22:11)", "entry");
