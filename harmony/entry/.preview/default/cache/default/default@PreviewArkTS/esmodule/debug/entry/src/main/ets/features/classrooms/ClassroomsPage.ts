...
export class ClassroomsPage extends ViewPU {
    ...
    Chip(label: string, active: boolean, onTap: () => void, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(label);
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(18:5)", "entry");
            Text.layoutWeight(1);
    ...
    FilterPanel(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(25:5)", "entry");
            Column.width('100%');
            Column.padding(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(26:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125832302, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            SymbolGlyph.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(27:9)", "entry");
            SymbolGlyph.fontSize(18);
            SymbolGlyph.fontColor([this.palette().primary]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('节次');
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(28:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 6 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(30:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(33:7)", "entry");
            Divider.color(this.palette().line);
        }, Divider);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(34:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125832143, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            SymbolGlyph.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(35:9)", "entry");
            SymbolGlyph.fontSize(18);
            SymbolGlyph.fontColor([this.palette().primary]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('容量');
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(36:9)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(15);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 6 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(38:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(41:7)", "entry");
            Divider.color(this.palette().line);
        }, Divider);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(42:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125833333, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            SymbolGlyph.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(43:9)", "entry");
            SymbolGlyph.fontSize(20);
            SymbolGlyph.fontColor([this.palette().primary]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 2 });
            Column.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(44:9)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('仅显示有多媒体设备');
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(45:11)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(13);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(46:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Toggle.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(48:9)", "entry");
    ...
    ClassroomCard(item: ClassroomAvailability, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(55:5)", "entry");
            Row.width('100%');
            Row.padding(11);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create($r('app.media.hero_classroom'));
            Image.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(56:7)", "entry");
            Image.width(105);
            Image.height(78);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(57:7)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(item.classroom?.name ?? item.name ?? '教室');
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(58:9)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(59:9)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 5 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(61:9)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.slot);
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(62:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if ((item.classroom?.has_multimedia ?? item.has_multimedia) !== false) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('多媒体');
                        Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(64:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(68:7)", "entry");
            SymbolGlyph.fontSize(18);
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(73:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(75:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(76:9)", "entry");
            Column.width('100%');
            Column.padding({ left: 14, right: 14, bottom: 24 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create($r('app.media.hero_classroom'));
            Image.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(77:11)", "entry");
            Image.width('100%');
            Image.height(170);
            Image.objectFit(ImageFit.Cover);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(79:11)", "entry");
            Button.width('100%');
            Button.height(52);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(80:13)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            if (this.loading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(81:35)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(82:22)", "entry");
                        SymbolGlyph.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(83:15)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(86:11)", "entry");
            Row.width('100%');
            Row.alignItems(VerticalAlign.Center);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(87:13)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Rect.create();
            Rect.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(88:15)", "entry");
            Rect.width(5);
            Rect.height(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('推荐空教室');
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(89:15)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(17);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(91:13)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`共 ${this.classrooms.length} 间可用`);
            Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(92:13)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
        }, Text);
        Text.pop();
            ...
            if (!this.loading && this.classrooms.length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/features/classrooms/ClassroomsPage.ets(95:13)", "entry");
                        Text.fontColor(this.palette().muted);
                        Text.fontSize(12);
