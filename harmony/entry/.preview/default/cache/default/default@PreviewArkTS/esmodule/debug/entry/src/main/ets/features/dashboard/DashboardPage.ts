...
export class DashboardPage extends ViewPU {
    ...
    SectionTitle(title: string, action: string, route: string, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(26:5)", "entry");
            Row.width('100%');
            Row.alignItems(VerticalAlign.Center);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(27:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(31:7)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 2 });
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(32:7)", "entry");
            Row.onClick(() => this.onNavigate(route));
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(action);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(33:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(34:9)", "entry");
    ...
    HeaderProfile(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(46:5)", "entry");
            Row.width('100%');
            Row.alignItems(VerticalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(47:7)", "entry");
            Image.width(42);
            Image.height(42);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(53:7)", "entry");
            Column.alignItems(HorizontalAlign.Start);
            Column.margin({ left: 10 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.userName);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(54:9)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(15);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(58:9)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(11);
        }, Text);
        Text.pop();
    ...
    ExamHero(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(72:5)", "entry");
            Stack.width('100%');
            Stack.height(188);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777217, "type": 20000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(73:7)", "entry");
            Image.width('100%');
            Image.height('100%');
            Image.objectFit(ImageFit.Cover);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(77:7)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(88:7)", "entry");
            Column.width('72%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(89:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(95:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 7 });
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(99:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('查看复习计划');
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(100:11)", "entry");
            Text.fontColor('#FFFFFFFF');
            Text.fontSize(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(104:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 6 });
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(119:7)", "entry");
            Row.align(Alignment.Bottom);
            Row.margin({ bottom: 10 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(120:9)", "entry");
            Circle.width(7);
            Circle.height(7);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(121:9)", "entry");
            Circle.width(6);
            Circle.height(6);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(122:9)", "entry");
            Circle.width(6);
            Circle.height(6);
            Circle.fill('#6BFFFFFF');
        }, Circle);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(123:9)", "entry");
            Circle.width(6);
            Circle.height(6);
            Circle.fill('#6BFFFFFF');
        }, Circle);
    ...
    QuickActions(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(137:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(145:9)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Stack.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(146:11)", "entry");
                    Stack.width(44);
                    Stack.height(44);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    SymbolGlyph.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(147:13)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(155:11)", "entry");
                    Text.fontColor(this.palette().text);
                    Text.fontSize(11);
                    Text.maxLines(1);
                }, Text);
    ...
    CourseMeta(symbol: Resource, text: string, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 5 });
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(173:5)", "entry");
            Row.alignItems(VerticalAlign.Center);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create(symbol);
            SymbolGlyph.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(174:7)", "entry");
            SymbolGlyph.fontSize(15);
            SymbolGlyph.fontColor(['#E0FFFFFF']);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(text);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(175:7)", "entry");
    ...
    TimelineRow(title: string, meta: string, state: string, upcoming: boolean, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(182:5)", "entry");
            Row.width('100%');
            Row.alignItems(VerticalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(183:7)", "entry");
            Circle.width(9);
            Circle.height(9);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(189:7)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(190:9)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(12);
            Text.fontWeight(FontWeight.Medium);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(meta);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(194:9)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(9.5);
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(state);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(199:7)", "entry");
    ...
    TodayCourseCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(213:5)", "entry");
            Column.width('100%');
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(215:7)", "entry");
            Row.width('100%');
            Row.margin({ top: 13 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(216:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('下一节');
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(217:11)", "entry");
            Text.fontColor('#FFFFFFFF');
            Text.fontSize(10);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(223:11)", "entry");
            Text.fontColor('#FFFFFFFF');
            Text.fontSize(22);
            Text.fontWeight(FontWeight.Bold);
            Text.margin({ top: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(228:11)", "entry");
        }, Blank);
        Blank.pop();
        this.CourseMeta.bind(this)({ "id": 125832302, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" }, '10:00 · 进行中');
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(230:11)", "entry");
            Blank.height(8);
        }, Blank);
        Blank.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(244:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(246:11)", "entry");
    ...
    StudyOverview(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(267:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(268:7)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('学习总览');
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(269:9)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(17);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(273:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125832271, "type": 40000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            SymbolGlyph.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(274:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(276:7)", "entry");
            Row.width('100%');
            Row.layoutWeight(1);
            Row.padding(12);
            Row.alignItems(VerticalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(277:9)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('本周进度');
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(278:11)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('72%');
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(279:11)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(28);
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('较上周 ↑12%');
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(280:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.Center });
            Stack.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(284:9)", "entry");
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Progress.create({ value: 72, total: 100, type: ProgressType.Ring });
            Progress.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(285:11)", "entry");
            Progress.width(65);
            Progress.height(65);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(291:11)", "entry");
    ...
    DeadlineRow(title: string, due: string, urgent: boolean, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(313:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.Center });
            Stack.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(314:7)", "entry");
            Stack.width(28);
            Stack.height(28);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(315:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(323:7)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(324:9)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(10.5);
            Text.maxLines(1);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(due);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(325:9)", "entry");
    ...
    Deadlines(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(342:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(344:7)", "entry");
            Blank.height(9);
        }, Blank);
        Blank.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(346:7)", "entry");
            Blank.height(7);
        }, Blank);
        Blank.pop();
    ...
    CampusUpdate(title: string, summary: string, tint: string, symbol: Resource, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(358:5)", "entry");
            Column.width(236);
            Column.border({ width: 1, color: this.palette().line });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.Center });
            Stack.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(359:7)", "entry");
            Stack.width('100%');
            Stack.height(76);
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777217, "type": 20000, params: [], "bundleName": "com.example.campusmate", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(360:9)", "entry");
            Image.width('100%');
            Image.height('100%');
            Image.objectFit(ImageFit.Cover);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(364:9)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create(symbol);
            SymbolGlyph.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(365:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 2 });
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(369:7)", "entry");
            Column.width('100%');
            Column.padding(11);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(370:9)", "entry");
            Text.fontColor(this.palette().text);
            Text.fontSize(12);
            Text.fontWeight(FontWeight.Medium);
            Text.maxLines(1);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(summary);
            Text.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(375:9)", "entry");
            Text.fontColor(this.palette().muted);
            Text.fontSize(10);
            Text.maxLines(1);
        }, Text);
    ...
    CampusUpdates(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(389:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor(this.palette().surface);
            Column.borderRadius(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(391:7)", "entry");
            Scroll.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(392:9)", "entry");
        }, Row);
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(409:5)", "entry");
            Scroll.width('100%');
            Scroll.height('100%');
            Scroll.scrollBar(BarState.Off);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(410:7)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(415:9)", "entry");
            Row.width('100%');
        }, Row);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/features/dashboard/DashboardPage.ets(421:9)", "entry");
            Blank.height(92);
        }, Blank);
        Blank.pop();
        Column.pop();
